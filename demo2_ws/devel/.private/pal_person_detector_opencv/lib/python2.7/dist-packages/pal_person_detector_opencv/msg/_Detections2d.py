...
"""autogenerated by genpy from pal_person_detector_opencv/Detections2d.msg. Do not edit."""
import codecs
import sys
...
import pal_person_detector_opencv.msg
import std_msgs.msg

class Detections2d(genpy.Message):
  _md5sum = "508e4e5ac7930673178d3ead64ba3f4b"
  _type = "pal_person_detector_opencv/Detections2d"
...
"""
  ...
  _slot_types = ['std_msgs/Header','pal_person_detector_opencv/Detection2d[]','geometry_msgs/TransformStamped']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pal_person_detector_opencv.msg.Detection2d()
        _x = val1
        start = end
        end += 32
