...
(cl:in-package pal_person_detector_opencv-msg)
...
(cl:defclass <Detections2d> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector pal_person_detector_opencv-msg:Detection2d)
   :initform (cl:make-array 0 :element-type 'pal_person_detector_opencv-msg:Detection2d :initial-element (cl:make-instance 'pal_person_detector_opencv-msg:Detection2d)))
   (camera_pose
    :reader camera_pose
    :initarg :camera_pose
...
(cl:defmethod cl:initialize-instance :after ((m <Detections2d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detections2d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_person_detector_opencv-msg:<Detections2d> is deprecated: use pal_person_detector_opencv-msg:Detections2d instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Detections2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:header-val is deprecated.  Use pal_person_detector_opencv-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <Detections2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:detections-val is deprecated.  Use pal_person_detector_opencv-msg:detections instead.")
  (detections m))

(cl:ensure-generic-function 'camera_pose-val :lambda-list '(m))
(cl:defmethod camera_pose-val ((m <Detections2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:camera_pose-val is deprecated.  Use pal_person_detector_opencv-msg:camera_pose instead.")
  (camera_pose m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Detections2d>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pal_person_detector_opencv-msg:Detection2d))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Detections2d>)))
  ...
  "pal_person_detector_opencv/Detections2d")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Detections2d)))
  "Returns string type for a message object of type 'Detections2d"
  "pal_person_detector_opencv/Detections2d")
