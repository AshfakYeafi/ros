...
(cl:defmethod cl:initialize-instance :after ((m <Detection2d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection2d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_person_detector_opencv-msg:<Detection2d> is deprecated: use pal_person_detector_opencv-msg:Detection2d instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Detection2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:x-val is deprecated.  Use pal_person_detector_opencv-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Detection2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:y-val is deprecated.  Use pal_person_detector_opencv-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Detection2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:width-val is deprecated.  Use pal_person_detector_opencv-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Detection2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_person_detector_opencv-msg:height-val is deprecated.  Use pal_person_detector_opencv-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Detection2d>)))
  ...
  "pal_person_detector_opencv/Detection2d")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Detection2d)))
  "Returns string type for a message object of type 'Detection2d"
  "pal_person_detector_opencv/Detection2d")
